...
exports.main = async (req, res, next)  => {
  ...
  let TIP_CLIENTE      = '01'// dependencia.TIP_CLIENTE;
  ...
  try {
    ...
    log_error.error(`EDS_VTFACTUR: valida_articulos : ${error} `);
    console.error('EDS_VTFACTUR: valida_articulos   : ',error);
    next()
  }
}