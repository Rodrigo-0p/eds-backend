...
let content 	  = [{COD_EMPRESA,COD_SUCURSAL,COD_DEPOSITO,IND_ENT_SAL}];
...
var valida 		 = [{
  ...
  try {
    ...
    log_error.error(`EDS_STENVIO: VALIDA_DEPOSITO : ${error} `);;
    console.error('EDS_STENVIO: VALIDA_DEPOSITO   : ',error)
    next()
  }
}